          ...
          if (layout == null) {
            try {
              if (this == OFFICIAL) {
                ...
                // NONE: empty layout with same field dimensions as the official layout
                AprilTagFieldLayout official = OFFICIAL.getLayout();
                layout = new AprilTagFieldLayout(
                    new ArrayList<>(), official.getFieldLength(), official.getFieldWidth());
              }
